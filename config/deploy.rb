...
set :shared_paths, ['config/database.yml', 'config/secrets.yml', 'config/sendgrid.yml', 'data/historic_pipeline.csv', 'log',
...
task :setup => :environment do
  ...
  queue! %[touch "#{deploy_to}/shared/config/sendgrid.yml"]
  queue  %[echo "-----> Be sure to edit 'shared/config/sendgrid.yml'."]
